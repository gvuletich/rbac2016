 ...
 */
@Entity
@Table(name = "usuarios", catalog = "roledemo", schema = "")
@XmlRootElement
@NamedQueries({
...
public class Usuarios implements Serializable {
    ...
    public Usuarios(Integer idUsuario, String nombre, String password, boolean habilitado) {
        this.idUsuario = idUsuario;
        this.nombre = nombre;
